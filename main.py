...
ACCESS_TOKEN_STORE_PATH = os.getenv("ACCESS_TOKEN_STORE_PATH", os.path.join(os.path.dirname(__file__), ".superset_token"))
...
# Mount MCP server onto FastAPI app to enable SSE transport
